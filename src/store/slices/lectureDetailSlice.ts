...
const initialState = {
    lecture: {
        ...
        categoryName: null,
        imageUrl: "https://miro.medium.com/v2/resize:fit:1400/1*XXI-kg18liPn4XcfZmoqQQ.jpeg",
...
export const { setLectureDetail, clearLectureDetail } = lectureDetailSlice.actions
