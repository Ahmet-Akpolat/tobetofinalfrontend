                    ...
                    <div className="question">
                      <div className="d-flex justify-content-between">
                        <div className="question-count">
                          <b>{quizQuestionCount + 1}</b>/
                          <b>{quizQuestions?.questions.length}</b>
                        </div>
                        <div className="question-count">
                          {minuteControl && <b>{showMinute}:</b>}
                          <b>{showSecond}</b>
                        </div>
                      </div>
                    </div>
                    <div className="question">
                      ...
                      <div className="main">
                        <div className="title">
                          <p>
                            <span>
                              {
                                quizQuestions?.questions[quizQuestionCount]
                                  .sentence
                              }
                              ?
                            </span>
                      ...
                      <div className="control">
                        ...
                        {quizQuestionCount + 1 ==
                          quizQuestions?.questions.length && (
                          <button
                            className="btn btn-finishExam"
                            onClick={() => finishTheExam()}
                          >
                            Sınavı Bitir
                          </button>
                        )}
